...
<nav class="navbar navbar-default" role="navigation">
  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav">
      <li class="active"><a href="#"> <IMG alt="" 
            src="images/home.png" 
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    ...
    <TD width="100%">
              ...
              <p><br><br><br><br><br>
<CENTER><H1 class="Letras"><strong>PROT&Oacute;TIPO PARA AVALIA&Ccedil;&Atilde;O DE  CANDIDATO.</strong></H1><p class="Letras">
A Avalia&ccedil;&atilde;o consiste no desenvolvimento da funcionalidade "<a href="con_desempenho">Performance Comercial</a>" (Comercial -> Performance Comercial).</CENTER><br>
